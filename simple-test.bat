...
echo ========================================
echo    YANA PURE BACKEND - SIMPLE TESTS
echo ========================================
echo.
...
echo Starting simple endpoint tests...
...
REM Test 4: Verify OTP
if defined OTP_CODE (
    echo [%TOTAL_TESTS%] Testing: Verify OTP
    set /a TOTAL_TESTS+=1
    ...
    if !errorlevel! equ 0 (
        ...
        REM Extract access token (simplified)
...
REM Test 5: Get Current User
if defined ACCESS_TOKEN (
    echo [%TOTAL_TESTS%] Testing: Get Current User
    set /a TOTAL_TESTS+=1
