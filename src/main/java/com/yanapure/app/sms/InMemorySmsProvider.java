...
/**
 * In-memory SMS provider for testing and development
...
public class InMemorySmsProvider implements SmsProvider {
    ...
    public boolean sendSms(String phoneNumber, String message) {
        ...
        sentMessages.computeIfAbsent(phoneNumber, k -> new ConcurrentLinkedQueue<>())
                   .offer(message);
    ...
    public String getLastMessage(String phoneNumber) {
        ...
        return messages != null && !messages.isEmpty() ? messages.peek() : null;
    }
