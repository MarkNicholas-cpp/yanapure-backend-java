...
/**
 * Masking rules: - mask(e164): "+<cc><fixed-stars><last2>" * if cc = "1" => 7 stars (e.g.,
 * +1*******71) * else => 6 stars (e.g., +91******88) - mask(e164, visibleDigits):
 * "+<cc>******<tailN>" - maskCompletely(): "+**********" (10 stars) - invalid input => "***"
 */
