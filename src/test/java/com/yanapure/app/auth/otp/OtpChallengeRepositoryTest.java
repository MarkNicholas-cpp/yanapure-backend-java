...
public class OtpChallengeRepositoryTest {
    ...
    void testFindTopByPhoneAndConsumedAtIsNullOrderByCreatedAtDesc() {
        ...
        // When
        Optional<OtpChallenge> found = otpChallengeRepository
    ...
    void testCountByPhoneAndConsumedAtIsNullAndExpiresAtAfter() {
        ...
        // When
        long count = otpChallengeRepository
                .countByPhoneAndConsumedAtIsNullAndExpiresAtAfter(phone, now);
    ...
    void testFindByPhoneOrderByCreatedAtDesc() {
        ...
        // When
        List<OtpChallenge> challenges = otpChallengeRepository
                .findByPhoneOrderByCreatedAtDesc(phone);
    ...
    void testFindByExpiresAtBefore() {
        ...
        // When
        List<OtpChallenge> expired = otpChallengeRepository
    ...
    void testCountByPhoneAndCreatedAtAfter() {
        ...
        // When
        long count = otpChallengeRepository
                .countByPhoneAndCreatedAtAfter(phone, since);
