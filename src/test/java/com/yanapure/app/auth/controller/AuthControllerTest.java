...
public class AuthControllerTest {
    ...
    void testSendOtpWithInvalidPhone() throws Exception {
        ...
        doThrow(new ApiException("PHONE_INVALID", "Phone must be E.164 (e.g., +14155552671)"))
                .when(authenticationService).initiatePhoneAuth(anyString(), anyString());
    ...
    void testVerifyOtpSuccess() throws Exception {
        ...
        AuthenticationService.AuthResult result = new AuthenticationService.AuthResult(
                user, "access-token", "refresh-token", sessionId);

        when(authenticationService.verifyPhoneAndLogin(anyString(), anyString(), anyString(), anyString()))
                .thenReturn(result);
